...
<p>Welcome <a href="">Kevin</a>, <a href="">Logout</a></p>
  ...
  <table border="1"><tr> <td bgcolor="#0054a6>"  
    <div id="account">
<p>Welcome <a href="../public_html/account.php">Kevin</a>, <a href="../public_html/logout.php">Logout </a></p></div><div id="search"><form action="../public_html/searchresults.php" method="GET" name="searchform"><p> Search </p><input type="text" name="search" class="tb"/><input type="submit"></form></div>
   </td></tr></table>

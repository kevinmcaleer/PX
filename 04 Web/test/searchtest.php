...
<body>
<div id="searchbox">
<form name="search" action="../resources/includes/SearchSuggest.php" method="get" target="searchWindow">
...
<div id="suggest">
<iframe name="searchWindow" src="../resources/includes/SearchSuggest.php" width="300"  frameborder="0"></iframe></div>
